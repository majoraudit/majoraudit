export const CLASS_YEARS = ["2026", "2027", "2028", "2029"] as const;

export const UNDERGRAD_MAJORS: string[] = [
...
export const LANGUAGE_SUBJECTS: { code: string; label: string }[] = [
  { code: "ARBC", label: "Arabic" },
  { code: "CHNS", label: "Chinese" },
  { code: "FREN", label: "French" },
  { code: "GERM", label: "German" },
  { code: "HEBR", label: "Hebrew" },
  { code: "ITAL", label: "Italian" },
  { code: "JAPN", label: "Japanese" },
  { code: "KREN", label: "Korean" },
  { code: "LATN", label: "Latin" },
  { code: "PORT", label: "Portuguese" },
  { code: "RUSS", label: "Russian" },
  { code: "SPAN", label: "Spanish" },
].sort((a, b) => a.label.localeCompare(b.label));

export const LANGUAGE_LEVELS = ["L1", "L2", "L3", "L4", "L5"] as const;
